export const SegmentedControl = ({
  ...
  return (
    <div
      className={`inline-flex items-center p-1.5 bg-neutral-100 dark:bg-neutral-100 border border-neutral-200 dark:border-neutral-200/80 rounded-2xl select-none ${
            ...
            className={`
              ...
              ${
                isSelected
                  ...
                  : 'text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-200/60 dark:hover:bg-neutral-200/60'
              }
            `}
          >
            {Icon && (
