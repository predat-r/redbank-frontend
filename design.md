...
section defines *how*, so the adaptation is consistent rather than ad hoc per module.
...
*(Living spec — pages and their content blocks will evolve. Structural rules above stay fixed.)*
